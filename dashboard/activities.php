            ...
            <div class="">
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="col-md-5 col-sm-5 col-xs-12 pull-right">
                            <a href="activity_input.php" class="btn btn-block btn-primary"><i class="fa fa-folder"></i> Add New Activity </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h4>All Activities/Club/Organization/Volunteer Experience</h4>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">

                                <p>You can add, modify or delete activity</p>
...
<script>
    window.onload = function() {
        console.log("ready");
        get_events('<?php echo $schedule_id?>', "ACT");
    };
</script>
</body>
</html>