...
if(isset($_GET['eventId'])) {
    $edit = true;
    $actionUrl = "javascript:update_event('". $schedule_id. "', '". $_GET['eventId']. "', 'ACT');";
}
else {
    $actionUrl = "javascript:create_event('". $schedule_id. "', 'ACT');";
}
...
<head>
    ...
    <title>New Activity | Elegant Resume</title>
                ...
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="col-md-5 col-sm-5 col-xs-12 pull-right">
                            <a href="help.php#act" class="btn btn-block btn-info"><i class="fa fa-info-circle"></i> Help </a>
                        </div>
                    </div>
                </div>
                                ...
                                <form data-parsley-validate action="<?php echo $actionUrl?>" class="form-horizontal form-label-left">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Activity/Organization<span class="required">*</span>
                                                    </label>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea id="description" class="form-control" rows="10" placeholder='Small description about your experience...' data-parsley-trigger="keyup" data-parsley-minlength="0" data-parsley-maxlength="1000" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="btn_label" placeholder="i.e: Visit Activity Website..." class="form-control col-md-7 col-xs-12">
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button onclick="location.href='activity.php';" class="btn btn-primary" type="button">Cancel</button>
                                            <button type="submit" class="btn btn-success"><?php if($edit) echo "Update Activity"; else echo "Add New Activity";?></button>
                                        </div>
                                    </div>
    ...
    if($edit) { ?>
        <script>
            window.onload = function() {
                console.log("ready");
                $(".resume_tag").hashtags();
                get_details('<?php echo $schedule_id?>', "<?php echo $_GET['eventId']?>", "ACT");
            };
        </script>
    <?php
    } else { ?>
