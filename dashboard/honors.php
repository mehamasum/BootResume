...
<head>
    ...
    <title>Honors | Elegant Resume</title>
                ...
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="col-md-5 col-sm-5 col-xs-12 pull-right">
                            <a href="honor_input.php" class="btn btn-block btn-primary"><i class="fa fa-folder"></i> Add New Honor </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <p>You can add, modify or delete honors</p>
...
<script>
    window.onload = function() {
        console.log("ready");
        get_events('<?php echo $schedule_id?>', "HON");
    };
</script>
</body>
</html>