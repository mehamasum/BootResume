...
if(isset($_GET['eventId'])) {
    $edit = true;
    $actionUrl = "javascript:update_event('". $schedule_id. "', '". $_GET['eventId']. "', 'HON');";
}
else {
    $actionUrl = "javascript:create_event('". $schedule_id. "', 'HON');";
}
...
<head>
    ...
    <title>Honor | Elegant Resume</title>
                                ...
                                <form data-parsley-validate action="<?php echo $actionUrl?>" class="form-horizontal form-label-left">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subtitle1">Issuer<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="btn_label" placeholder="i.e: Visit Honor Website..." class="form-control col-md-7 col-xs-12">
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button onclick="location.href='honors.php';" class="btn btn-primary" type="button">Cancel</button>
                                            <button type="submit" class="btn btn-success"><?php if($edit) echo "Update Honor"; else echo "Add New Honor";?></button>
                                        </div>
                                    </div>
    ...
    if($edit) { ?>
        <script>
            window.onload = function() {
                console.log("ready");
                $(".resume_tag").hashtags();
                get_details('<?php echo $schedule_id?>', "<?php echo $_GET['eventId']?>", "HON");
            };
        </script>
    <?php
    } else { ?>
